...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__createHashHistory__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__createMemoryHistory__ = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Prompt__ = __webpack_require__(38);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__generatePath__ = __webpack_require__(42);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__matchPath__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__withRouter__ = __webpack_require__(44);
...
exports.NoAuthRoute = exports.PrivateRoute = undefined;
...
var NoAuthRoute = function (_Component) {
    _inherits(NoAuthRoute, _Component);

    function NoAuthRoute() {
        _classCallCheck(this, NoAuthRoute);

        return _possibleConstructorReturn(this, (NoAuthRoute.__proto__ || Object.getPrototypeOf(NoAuthRoute)).apply(this, arguments));
    }

    _createClass(NoAuthRoute, [{
        key: 'render',
        value: function render() {
            var _props = this.props,
                ...
                rest = _objectWithoutProperties(_props, ['component', 'isAuthenticated', 'config']);

            return _react2.default.createElement(_reactRouterDom.Route, _extends({}, rest, { render: function render(props) {
                    return isAuthenticated() ? _react2.default.createElement(_reactRouterDom.Redirect, { to: config.defaultUrl.authenticated }) : _react2.default.createElement(InnerComponent, props);
                } }));
        }
    }]);
...
var PrivateRoute = function (_Component2) {
    _inherits(PrivateRoute, _Component2);
    ...
    _createClass(PrivateRoute, [{
        ...
        value: function render() {
            var _props2 = this.props,
                InnerComponent = _props2.component,
                isAuthenticated = _props2.isAuthenticated,
                config = _props2.config,
                rest = _objectWithoutProperties(_props2, ['component', 'isAuthenticated', 'config']);

            return _react2.default.createElement(_reactRouterDom.Route, _extends({}, rest, { render: function render(props) {
                    return isAuthenticated() ? _react2.default.createElement(InnerComponent, props) : _react2.default.createElement(_reactRouterDom.Redirect, { to: config.defaultUrl.noAuthenticated });
                } }));
        }
    }]);
...
exports.NoAuthRoute = NoAuthRoute;
